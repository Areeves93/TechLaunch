...
for (var i = 0; i < '5'; i++) {
  ...
  Answer: x= 50 thug life
   ...
   var city = "Miami"
   Answer:'John Martinez is from Miami'
   ...
   Answer:'The total power in generator 1 is 32mw'
   ...
   Answer: '"que bola acere" is similar to "sup dawg" in spanish.'
   ...
   */
   ...
   if ( carAge>10;mileage>150000,'kia'){
